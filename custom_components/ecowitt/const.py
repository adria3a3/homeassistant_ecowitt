...
SENSOR_TYPES = {
    TYPE_BAROMABSHPA: ("Absolute Pressure", UnitOfPressure.HPA,
                       TYPE_SENSOR, SensorDeviceClass.PRESSURE,
                       "mdi:gauge", S_METRIC, SensorDeviceClass.MEASUREMENT),
    TYPE_BAROMRELHPA: ("Relative Pressure", UnitOfPressure.HPA,
                       TYPE_SENSOR, SensorDeviceClass.PRESSURE,
                       "mdi:gauge", S_METRIC, SensorDeviceClass.MEASUREMENT),
    TYPE_BAROMABSIN: ("Absolute Pressure", UnitOfPressure.INHG,
                      TYPE_SENSOR, SensorDeviceClass.PRESSURE,
                      "mdi:gauge", S_IMPERIAL, SensorDeviceClass.MEASUREMENT),
    TYPE_BAROMRELIN: ("Relative Pressure", UnitOfPressure.INHG,
                      TYPE_SENSOR, SensorDeviceClass.PRESSURE,
                      "mdi:gauge", S_IMPERIAL, SensorDeviceClass.MEASUREMENT),
    TYPE_RAINRATEIN: ("Rain Rate", f"{UnitOfLength.INCHES}/{UnitOfTime.HOURS}",
                      TYPE_SENSOR, None, "mdi:water", S_IMPERIAL,
                      SensorDeviceClass.TOTAL_INCREASING),
    TYPE_EVENTRAININ: ("Event Rain Rate", f"{UnitOfLength.INCHES}/{UnitOfTime.HOURS}",
                       TYPE_SENSOR, None, "mdi:water", S_IMPERIAL,
                       SensorDeviceClass.TOTAL_INCREASING),
    TYPE_HOURLYRAININ: ("Hourly Rain Rate", f"{UnitOfLength.INCHES}/{UnitOfTime.HOURS}",
                        TYPE_SENSOR, None, "mdi:water", S_IMPERIAL,
                        SensorDeviceClass.TOTAL_INCREASING),
    TYPE_TOTALRAININ: ("Total Rain Rate", f"{UnitOfLength.INCHES}",
                       TYPE_SENSOR, None, "mdi:water", S_IMPERIAL,
                       SensorDeviceClass.TOTAL_INCREASING),
    TYPE_DAILYRAININ: ("Daily Rain Rate", f"{UnitOfLength.INCHES}/{UnitOfTime.DAYS}",
                       TYPE_SENSOR, None, "mdi:water", S_IMPERIAL,
                       SensorDeviceClass.TOTAL_INCREASING),
    TYPE_WEEKLYRAININ: ("Weekly Rain Rate", f"{UnitOfLength.INCHES}/{UnitOfTime.WEEKS}",
                        TYPE_SENSOR, None, "mdi:water", S_IMPERIAL,
                        SensorDeviceClass.TOTAL_INCREASING),
    TYPE_MONTHLYRAININ: ("Monthly Rain Rate", f"{UnitOfLength.INCHES}/{UnitOfTime.MONTHS}",
                         TYPE_SENSOR, None, "mdi:water", S_IMPERIAL,
                         SensorDeviceClass.TOTAL_INCREASING),
    TYPE_YEARLYRAININ: ("Yearly Rain Rate", f"{UnitOfLength.INCHES}/{UnitOfTime.YEARS}",
                        TYPE_SENSOR, None, "mdi:water", S_IMPERIAL,
                        SensorDeviceClass.TOTAL_INCREASING),
    TYPE_RAINRATEMM: ("Rain Rate", f"mm/{UnitOfTime.HOURS}",
                      TYPE_SENSOR, None, "mdi:water", S_METRIC,
                      SensorDeviceClass.TOTAL_INCREASING),
    TYPE_EVENTRAINMM: ("Event Rain Rate", f"mm/{UnitOfTime.HOURS}",
                       TYPE_SENSOR, None, "mdi:water", S_METRIC,
                       SensorDeviceClass.TOTAL_INCREASING),
    TYPE_HOURLYRAINMM: ("Hourly Rain Rate", f"mm/{UnitOfTime.HOURS}",
                        TYPE_SENSOR, None, "mdi:water", S_METRIC,
                        SensorDeviceClass.TOTAL_INCREASING),
    TYPE_TOTALRAINMM: ("Total Rain Rate", f"mm",
                       TYPE_SENSOR, None, "mdi:water", S_METRIC,
                       SensorDeviceClass.TOTAL_INCREASING),
    TYPE_DAILYRAINMM: ("Daily Rain Rate", f"mm/{UnitOfTime.DAYS}",
                       TYPE_SENSOR, None, "mdi:water", S_METRIC,
                       SensorDeviceClass.TOTAL_INCREASING),
    TYPE_WEEKLYRAINMM: ("Weekly Rain Rate", f"mm/{UnitOfTime.WEEKS}",
                        TYPE_SENSOR, None, "mdi:water", S_METRIC,
                        SensorDeviceClass.TOTAL_INCREASING),
    TYPE_MONTHLYRAINMM: ("Monthly Rain Rate", f"mm/{UnitOfTime.MONTHS}",
                         TYPE_SENSOR, None, "mdi:water", S_METRIC,
                         SensorDeviceClass.TOTAL_INCREASING),
    TYPE_YEARLYRAINMM: ("Yearly Rain Rate", f"mm/{UnitOfTime.YEARS}",
                        TYPE_SENSOR, None, "mdi:water", S_METRIC,
                        SensorDeviceClass.TOTAL_INCREASING),
    TYPE_HUMIDITY: ("Humidity", PERCENTAGE,
                    TYPE_SENSOR, SensorDeviceClass.HUMIDITY,
                    "mdi:water-percent", 0, SensorDeviceClass.MEASUREMENT),
    ...
    TYPE_WINDDIR: ("Wind Direction", DEGREE,
                   TYPE_SENSOR, None, "mdi:compass", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WINDDIR_A10: ("Wind Direction 10m Avg", DEGREE,
                       TYPE_SENSOR, None, "mdi:compass", 0,
                       SensorDeviceClass.MEASUREMENT),
    TYPE_WINDSPEEDKMH: ("Wind Speed", UnitOfSpeed.KILOMETERS_PER_HOUR,
    ...
    TYPE_WINDSPEEDMPH: ("Wind Speed", UnitOfSpeed.MILES_PER_HOUR,
                        ...
                        SensorDeviceClass.MEASUREMENT),
    TYPE_WINDSPEEDMPH_A10: ("Wind Speed 10m Avg", UnitOfSpeed.MILES_PER_HOUR,
                            TYPE_SENSOR, None, "mdi:weather-windy",
                            S_IMPERIAL, SensorDeviceClass.MEASUREMENT),
    TYPE_WINDGUSTMPH: ("Wind Gust", UnitOfSpeed.MILES_PER_HOUR,
                       TYPE_SENSOR, None, "mdi:weather-windy", S_IMPERIAL,
                       SensorDeviceClass.MEASUREMENT),
    TYPE_MAXDAILYGUST: ("Max Daily Wind Gust", UnitOfSpeed.MILES_PER_HOUR,
                        TYPE_SENSOR, None, "mdi:weather-windy", S_IMPERIAL,
                        SensorDeviceClass.MEASUREMENT),
    TYPE_MAXDAILYGUSTKMH: ("Max Daily Wind Gust", UnitOfSpeed.KILOMETERS_PER_HOUR,
                           TYPE_SENSOR, None, "mdi:weather-windy", S_METRIC,
                           SensorDeviceClass.MEASUREMENT),
    TYPE_WINDGUSTMS: ("Wind Gust", UnitOfSpeed.METERS_PER_SECOND,
                      TYPE_SENSOR, None, "mdi:weather-windy", S_METRIC_MS,
                      SensorDeviceClass.MEASUREMENT),
    TYPE_WINDSPEEDMS: ("Wind Speed", UnitOfSpeed.METERS_PER_SECOND,
                       TYPE_SENSOR, None, "mdi:weather-windy", S_METRIC_MS,
                       SensorDeviceClass.MEASUREMENT),
    TYPE_WINDSPEEDMS_A10: ("Wind Speed", UnitOfSpeed.METERS_PER_SECOND,
                           TYPE_SENSOR, None, "mdi:weather-windy", S_METRIC_MS,
                           SensorDeviceClass.MEASUREMENT),
    TYPE_MAXDAILYGUSTMS: ("Max Daily Wind Gust", UnitOfSpeed.METERS_PER_SECOND,
                          TYPE_SENSOR, None, "mdi:weather-windy", S_METRIC_MS,
                          SensorDeviceClass.MEASUREMENT),
    TYPE_TEMPC: ("Outdoor Temperature", UnitOfTemperature.CELSIUS,
                 TYPE_SENSOR, SensorDeviceClass.TEMPERATURE, "mdi:thermometer", 0,
                 SensorDeviceClass.MEASUREMENT),
    TYPE_TEMP1C: ("Temperature 1", UnitOfTemperature.CELSIUS,
                  TYPE_SENSOR, SensorDeviceClass.TEMPERATURE, "mdi:thermometer", 0,
                  SensorDeviceClass.MEASUREMENT),
    TYPE_TEMP2C: ("Temperature 2", UnitOfTemperature.CELSIUS,
                  TYPE_SENSOR, SensorDeviceClass.TEMPERATURE, "mdi:thermometer", 0,
                  SensorDeviceClass.MEASUREMENT),
    TYPE_TEMP3C: ("Temperature 3", UnitOfTemperature.CELSIUS,
                  TYPE_SENSOR, SensorDeviceClass.TEMPERATURE, "mdi:thermometer", 0,
                  SensorDeviceClass.MEASUREMENT),
    TYPE_TEMP4C: ("Temperature 4", UnitOfTemperature.CELSIUS,
                  TYPE_SENSOR, SensorDeviceClass.TEMPERATURE, "mdi:thermometer", 0,
                  SensorDeviceClass.MEASUREMENT),
    TYPE_TEMP5C: ("Temperature 5", UnitOfTemperature.CELSIUS,
                  TYPE_SENSOR, SensorDeviceClass.TEMPERATURE, "mdi:thermometer", 0,
                  SensorDeviceClass.MEASUREMENT),
    TYPE_TEMP6C: ("Temperature 6", UnitOfTemperature.CELSIUS,
                  TYPE_SENSOR, SensorDeviceClass.TEMPERATURE, "mdi:thermometer", 0,
                  SensorDeviceClass.MEASUREMENT),
    TYPE_TEMP7C: ("Temperature 7", UnitOfTemperature.CELSIUS,
                  TYPE_SENSOR, SensorDeviceClass.TEMPERATURE, "mdi:thermometer", 0,
                  SensorDeviceClass.MEASUREMENT),
    TYPE_TEMP8C: ("Temperature 8", UnitOfTemperature.CELSIUS,
                  TYPE_SENSOR, SensorDeviceClass.TEMPERATURE, "mdi:thermometer", 0,
                  SensorDeviceClass.MEASUREMENT),
    TYPE_TEMPINC: ("Indoor Temperature", UnitOfTemperature.CELSIUS,
                   TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                   "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_DEWPOINTC: ("Dewpoint", UnitOfTemperature.CELSIUS,
                     TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                     "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_DEWPOINTINC: ("Indoor Dewpoint", UnitOfTemperature.CELSIUS,
                       TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                       "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_DEWPOINT1C: ("Dewpoint 1", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_DEWPOINT2C: ("Dewpoint 2", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_DEWPOINT3C: ("Dewpoint 3", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_DEWPOINT4C: ("Dewpoint 4", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_DEWPOINT5C: ("Dewpoint 5", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_DEWPOINT6C: ("Dewpoint 6", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_DEWPOINT7C: ("Dewpoint 7", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_DEWPOINT8C: ("Dewpoint 8", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WINDCHILLC: ("Windchill", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_SOLARRADIATION: ("Solar Radiation", f"{UnitOfPower.KILO_WATT_HOUR}/m^2",
                          TYPE_SENSOR, SensorDeviceClass.ILLUMINANCE,
                          "mdi:weather-sunny", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_UV: ("UV Index", UV_INDEX,
              TYPE_SENSOR, None, "mdi:sunglasses", 0, SensorDeviceClass.MEASUREMENT),
    ...
    TYPE_PM25_CH1: ("PM2.5 1", CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
                    TYPE_SENSOR, None, "mdi:eye", 0, SensorDeviceClass.MEASUREMENT),
    ...
    TYPE_LIGHTNING_TIME: ("Last Lightning strike", "",
                          ...
                          SensorDeviceClass.MEASUREMENT),
    TYPE_LIGHTNING_NUM: ("Lightning strikes", f"strikes/{UnitOfTime.DAYS}",
                         TYPE_SENSOR, None, "mdi:weather-lightning", 0,
                         SensorDeviceClass.TOTAL_INCREASING),
    TYPE_LIGHTNING_KM: ("Lightning strike distance", UnitOfLength.KILOMETERS,
                        TYPE_SENSOR, None, "mdi:ruler", S_METRIC,
                        SensorDeviceClass.MEASUREMENT),
    TYPE_LIGHTNING_MI: ("Lightning strike distance", UnitOfLength.MILES,
                        TYPE_SENSOR, None, "mdi:ruler", S_IMPERIAL,
                        SensorDeviceClass.MEASUREMENT),
    TYPE_LEAK_CH1: ("Leak Detection 1", LEAK_DETECTED, TYPE_BINARY_SENSOR,
                    SensorDeviceClass.MOISTURE, "mdi:leak", 0, None),
    ...
    TYPE_CO2_HUMIDITY: ("WH45 Humidity", PERCENTAGE,
                        TYPE_SENSOR, SensorDeviceClass.HUMIDITY,
                        "mdi:water-percent", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_CO2_TEMPC: ("WH45 Temperature", UnitOfTemperature.CELSIUS,
                     TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                     "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    ...
    TYPE_WH26BATT: ("WH26 Battery", "BATT", TYPE_BINARY_SENSOR,
                    SensorDeviceClass.BATTERY, "mdi:battery", 0, None),
    TYPE_WH40BATT: ("WH40 Battery", UnitOfElectricPotential.VOLT, TYPE_SENSOR,
    ...
    TYPE_WH65BATT: ("WH65 Battery", "BATT", TYPE_BINARY_SENSOR,
                    SensorDeviceClass.BATTERY, "mdi:battery", 0, None),
    TYPE_WH68BATT: ("WH68 Battery", UnitOfElectricPotential.VOLT, TYPE_SENSOR,
                    SensorDeviceClass.BATTERY, "mdi:battery", 0,
                    SensorDeviceClass.MEASUREMENT),
    TYPE_WH80BATT: ("WH80 Battery", UnitOfElectricPotential.VOLT, TYPE_SENSOR,
                    SensorDeviceClass.BATTERY, "mdi:battery", 0,
                    SensorDeviceClass.MEASUREMENT),
    TYPE_SOILBATT1: ("Soil Moisture 1 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE, "mdi:battery", 0,
                     SensorDeviceClass.MEASUREMENT),
    TYPE_SOILBATT2: ("Soil Moisture 2 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE, "mdi:battery", 0,
                     SensorDeviceClass.MEASUREMENT),
    TYPE_SOILBATT3: ("Soil Moisture 3 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE, "mdi:battery", 0,
                     SensorDeviceClass.MEASUREMENT),
    TYPE_SOILBATT4: ("Soil Moisture 4 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE, "mdi:battery", 0,
                     SensorDeviceClass.MEASUREMENT),
    TYPE_SOILBATT5: ("Soil Moisture 5 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE, "mdi:battery", 0,
                     SensorDeviceClass.MEASUREMENT),
    TYPE_SOILBATT6: ("Soil Moisture 6 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE, "mdi:battery", 0,
                     SensorDeviceClass.MEASUREMENT),
    TYPE_SOILBATT7: ("Soil Moisture 7 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE, "mdi:battery", 0,
                     SensorDeviceClass.MEASUREMENT),
    TYPE_SOILBATT8: ("Soil Moisture 8 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE, "mdi:battery", 0,
                     SensorDeviceClass.MEASUREMENT),
    ...
    TYPE_LEAKBATT8: ("Leak 8 Battery", PERCENTAGE, TYPE_SENSOR,
                     SensorDeviceClass.BATTERY, "mdi:battery", 0,
                     SensorDeviceClass.MEASUREMENT),
    TYPE_WN34TEMP1C: ("Soil Temperature 1", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34TEMP2C: ("Soil Temperature 2", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34TEMP3C: ("Soil Temperature 3", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34TEMP4C: ("Soil Temperature 4", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34TEMP5C: ("Soil Temperature 5", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34TEMP6C: ("Soil Temperature 6", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34TEMP7C: ("Soil Temperature 7", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34TEMP8C: ("Soil Temperature 8", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34BATT1: ("Soil Temperature 1 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE,
                     "mdi:battery", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34BATT2: ("Soil Temperature 2 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE,
                     "mdi:battery", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34BATT3: ("Soil Temperature 3 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE,
                     "mdi:battery", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34BATT4: ("Soil Temperature 4 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE,
                     "mdi:battery", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34BATT5: ("Soil Temperature 5 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE,
                     "mdi:battery", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34BATT6: ("Soil Temperature 6 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE,
                     "mdi:battery", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34BATT7: ("Soil Temperature 7 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE,
                     "mdi:battery", 0, SensorDeviceClass.MEASUREMENT),
    TYPE_WN34BATT8: ("Soil Temperature 8 Battery", UnitOfElectricPotential.VOLT,
                     TYPE_SENSOR, SensorDeviceClass.VOLTAGE,
                     "mdi:battery", 0, SensorDeviceClass.MEASUREMENT),
}
