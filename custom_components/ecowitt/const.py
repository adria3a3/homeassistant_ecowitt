...
SENSOR_TYPES = {
    ...
    TYPE_HUMIDITY: ("Humidity", PERCENTAGE,
                    ...
                    "mdi:water-percent", 0, SensorStateClass.MEASUREMENT),
    ...
    TYPE_WINDDIR: ("Wind Direction", DEGREE,
                   TYPE_SENSOR, None, "mdi:compass", 0, SensorStateClass.MEASUREMENT),
    ...
    TYPE_WINDSPEEDMPH_A10: ("Wind Speed 10m Avg", UnitOfSpeed.MILES_PER_HOUR,
                            ...
                            S_IMPERIAL, SensorStateClass.MEASUREMENT),
    ...
    TYPE_TEMPINC: ("Indoor Temperature", UnitOfTemperature.CELSIUS,
                   ...
                   "mdi:thermometer", 0, SensorStateClass.MEASUREMENT),
    ...
    TYPE_WINDCHILLC: ("Windchill", UnitOfTemperature.CELSIUS,
                      TYPE_SENSOR, SensorDeviceClass.TEMPERATURE,
                      "mdi:thermometer", 0, SensorStateClass.MEASUREMENT),
    TYPE_SOLARRADIATION: ("Solar Radiation", f"{UnitOfEnergy.KILO_WATT_HOUR}/m^2",
                          TYPE_SENSOR, SensorDeviceClass.ILLUMINANCE,
                          "mdi:weather-sunny", 0, SensorStateClass.MEASUREMENT),
    TYPE_UV: ("UV Index", UV_INDEX,
              TYPE_SENSOR, None, "mdi:sunglasses", 0, SensorStateClass.MEASUREMENT),
    ...
    TYPE_PM25_CH1: ("PM2.5 1", CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
                    TYPE_SENSOR, None, "mdi:eye", 0, SensorStateClass.MEASUREMENT),
    ...
    TYPE_WN34BATT1: ("Soil Temperature 1 Battery", UnitOfElectricPotential.VOLT,
                     ...
                     "mdi:battery", 0, SensorStateClass.MEASUREMENT),
